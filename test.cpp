...
void calcBuilding();
void calcMovement();
int calcPointingOn(double *vectorX, double *vectorY, double *vectorZ);
...
void debug(){
	...
	PointingOn =  calcPointingOn(&x, &y, &z);
...
int calcPointingOn(double* startX, double* startY, double* startZ){

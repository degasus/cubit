...
void Controller::parse_command_line(int argc, char *argv[]) {
	...
	desc.add_options()
		...
		("pointingDistance", po::value<int>()->default_value(400), "range to build and remove blocks")
		...
		("fastSpeedMultiplier", po::value<double>()->default_value(15.72341f), "speed multiplier when moving fast")
